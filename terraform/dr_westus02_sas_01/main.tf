...
resource "azurerm_virtual_machine" "virtual_machine" {
    ...
    storage_os_disk {
        ...
        vhd_uri = "${azurerm_storage_account.DRSASSTORAGE.primary_blob_endpoint}${azurerm_storage_container.DRSASSTORAGE01.name}/${var.vm_name_prefix}0${count.index}-osdisk.vhd"
        caching = "ReadWrite"
